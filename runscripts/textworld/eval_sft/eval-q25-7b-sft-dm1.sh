...
tokenizer_type=qwen25
valid_seen=False
load_env_seeds=True
model_path=$PROJ_DIR/models/local
run_type=eval
wandb_project_name=sdp_textworld_eval
experiment_name=q25_7b-sft-dm1-eval-all
...
num_nodes=1
micro_bs_per_gpu=$((128 / (num_nodes * 8)))
