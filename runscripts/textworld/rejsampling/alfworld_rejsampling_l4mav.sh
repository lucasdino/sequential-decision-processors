...
model_path=$PROJ_DIR/models/Qwen3-235B-A22B-Thinking-2507-FP8
...
uv run -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.engine_kwargs.vllm={'reasoning-parser': 'deepseek_r1', 'enable-reasoning': True} \
